...
var $tab_en_edic = null,
    params = null,
    colsEdi = null,
    newColHtml = '<div class="btn-group pull-right">	<button id="bEdit" type="button" class="btn btn-primary btn-sm" onclick="rowEdit(this);">		Editar	</button>	<button id="bElim" type="button" class="btn btn-danger btn-sm" onclick="rowElim(this);">		Apagar	</button>	<button id="bAcep" type="button" class="btn btn-info btn-sm" style="display:none;" onclick="rowAcep(this);">		Confirmar	</button><button id="bCanc" type="button" class="btn btn-warning btn-sm" style="display:none;" onclick="rowCancel(this);">		Cancel	</button></div>',    
