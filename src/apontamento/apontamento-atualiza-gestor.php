...
<main role="main" class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <h1>Lançamento de Horas - Gestor</h1>
            <hr>
            <form id="apontamento-linha">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="usr_id"  value="<?php print $_POST['s_usr_id'];?>" disabled>
                        </div>
                    </div>
                    <!-- Termina: Solicitante -->
                        ...
                        <select class="custom-select d-block w-100" id="opr_id" >
                            ...
                            <?php
                                ...
                                $s_tblprd = "
                                    ...
                                    $resultado = $db->query($s_tblprd);
                                    while($row = $resultado->fetchArray(SQLITE3_ASSOC)){
                                        if($_POST['oprnme'] == $row["oprnme"]){
                                            print '
                                            <option value="'.$row["opr_id"].'" selected>'.$row["oprnme"].' - '.$row["ctysgl"].'</option>
                                            ';
                                        }else{
                                            print '
...
?>
<script src="./apontamento-atualiza-gestor.js"></script>
