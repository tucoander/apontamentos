...
<form id="apontamento">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
            <input type="text" class="form-control" id="fr_tim" required >
            <div class="invalid-feedback" style="width: 100%;">
                Horário Obrigatório.
            </div>
            </div>
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
            <input type="text" class="form-control" id="to_tim" required >
            <div class="invalid-feedback" style="width: 100%;">
                Horário Obrigatório.
            </div>
            </div>
        ...
        <div class="col-md-6 mb-3">
            <label for="prd_id">Produto</label>
                <select class="custom-select d-block w-100" id="prd_id" required>
        ...
        <!-- Começa: Usuário -->
        <input type="text" class="form-control" id="usr_id" placeholder=""  value="<?php print $row["usr_id"];?>" hidden>
        <!-- Termina: Usuário -->
    </div>
